...
if s:configuration.enable_italic
  ...
  call sonokai#highlight('Constant', s:palette.blue, s:palette.none, 'italic')
else
  call sonokai#highlight('Type', s:palette.blue, s:palette.none, 'italic')
  call sonokai#highlight('Structure', s:palette.blue, s:palette.none, 'italic')
  call sonokai#highlight('StorageClass', s:palette.blue, s:palette.none, 'italic')
...
call sonokai#highlight('PreCondit', s:palette.red, s:palette.none, 'italic')
call sonokai#highlight('Include', s:palette.red, s:palette.none, 'italic')
call sonokai#highlight('Keyword', s:palette.red, s:palette.none, 'italic')
call sonokai#highlight('Define', s:palette.red, s:palette.none, 'italic')
call sonokai#highlight('Typedef', s:palette.red, s:palette.none, 'italic')
call sonokai#highlight('Exception', s:palette.red, s:palette.none, 'italic')
...
call sonokai#highlight('Macro', s:palette.purple, s:palette.none, 'italic')
call sonokai#highlight('Error', s:palette.red, s:palette.none, 'italic')
call sonokai#highlight('Label', s:palette.purple, s:palette.none, 'italic')
call sonokai#highlight('Special', s:palette.purple, s:palette.none, 'italic')
call sonokai#highlight('SpecialChar', s:palette.purple, s:palette.none, 'italic')
call sonokai#highlight('Boolean', s:palette.blue, s:palette.none)
